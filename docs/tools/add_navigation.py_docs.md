# Documentation: add_navigation.py
**Path:** `tools/add_navigation.py`
**Type:** .py
**Size:** 2170 characters

---

## File Metadata
- **Full Path:** `tools/add_navigation.py`
- **File Name:** `add_navigation.py`
- **Extension:** `.py`
- **Size:** 2170 bytes
...
## High-Level Overview
This Python file (`add_navigation.py`) contains Python source code.
...
**Functions Defined:** prev_this_next, iter_navbars, write_navbars
...
Located at: `tools/add_navigation.py`
