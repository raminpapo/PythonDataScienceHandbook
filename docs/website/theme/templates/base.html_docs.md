...
**Type:** .html
**Size:** 4218 characters

---

## File Metadata
- **Full Path:** `website/theme/templates/base.html`
- **File Name:** `base.html`
- **Extension:** `.html`
- **Size:** 4218 bytes
...
## High-Level Overview
This is a web asset file (`base.html`).

**Page Title:** {% block title %}{% endblock %} | {{ SITENAME }}

Content length: 4218 characters
...
Located at: `website/theme/templates/base.html`
