...
**Path:** `website/theme/templates/main.css`
**Type:** .css
**Size:** 4932 characters

---

## File Metadata
- **Full Path:** `website/theme/templates/main.css`
- **File Name:** `main.css`
- **Extension:** `.css`
- **Size:** 4932 bytes
...
## High-Level Overview
This is a web asset file (`main.css`).

Content length: 4932 characters
...
Located at: `website/theme/templates/main.css`
