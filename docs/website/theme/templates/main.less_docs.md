# Documentation: main.less
**Path:** `website/theme/templates/main.less`
**Type:** .less
**Size:** 6090 characters

---

## File Metadata
- **Full Path:** `website/theme/templates/main.less`
- **File Name:** `main.less`
- **Extension:** `.less`
- **Size:** 6090 bytes
...
## High-Level Overview
This is a web asset file (`main.less`).

Content length: 6090 characters
...
Located at: `website/theme/templates/main.less`
