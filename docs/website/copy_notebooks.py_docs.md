# Documentation: copy_notebooks.py
**Path:** `website/copy_notebooks.py`
**Type:** .py
**Size:** 4341 characters

---

## File Metadata
- **Full Path:** `website/copy_notebooks.py`
- **File Name:** `copy_notebooks.py`
- **Extension:** `.py`
- **Size:** 4341 bytes
...
## High-Level Overview
This Python file (`copy_notebooks.py`) contains Python source code.
...
**Functions Defined:** abspath_from_here, copy_notebooks
...
Located at: `website/copy_notebooks.py`

## Performance and Security Notes
- File size: 4341 bytes
