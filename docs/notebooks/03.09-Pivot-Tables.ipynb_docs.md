# Documentation: 03.09-Pivot-Tables.ipynb
**Path:** `notebooks/03.09-Pivot-Tables.ipynb`
**Type:** .ipynb
**Size:** 185852 characters

---

## File Metadata
- **Full Path:** `notebooks/03.09-Pivot-Tables.ipynb`
- **File Name:** `03.09-Pivot-Tables.ipynb`
- **Extension:** `.ipynb`
- **Size:** 185852 bytes
- **Last Modified:** 2025-11-18T22:10:25.529522
...
## High-Level Overview
This is a Jupyter Notebook file (`03.09-Pivot-Tables.ipynb`).
...
Located at: `notebooks/03.09-Pivot-Tables.ipynb`

## Performance and Security Notes
- File size: 185852 bytes
