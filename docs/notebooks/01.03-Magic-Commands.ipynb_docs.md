# Documentation: 01.03-Magic-Commands.ipynb
...
## File Metadata
- **Full Path:** `notebooks/01.03-Magic-Commands.ipynb`
- **File Name:** `01.03-Magic-Commands.ipynb`
- **Extension:** `.ipynb`
- **Size:** 9933 bytes
...
## High-Level Overview
This is a Jupyter Notebook file (`01.03-Magic-Commands.ipynb`).
...
Located at: `notebooks/01.03-Magic-Commands.ipynb`
