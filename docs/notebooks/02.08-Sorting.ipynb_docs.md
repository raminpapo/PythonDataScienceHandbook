# Documentation: 02.08-Sorting.ipynb
**Path:** `notebooks/02.08-Sorting.ipynb`
**Type:** .ipynb
**Size:** 62233 characters

---

## File Metadata
- **Full Path:** `notebooks/02.08-Sorting.ipynb`
- **File Name:** `02.08-Sorting.ipynb`
- **Extension:** `.ipynb`
- **Size:** 62233 bytes
...
## High-Level Overview
This is a Jupyter Notebook file (`02.08-Sorting.ipynb`).
...
Located at: `notebooks/02.08-Sorting.ipynb`
