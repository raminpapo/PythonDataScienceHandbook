# Documentation: Seattle2014.csv
**Path:** `notebooks/data/Seattle2014.csv`
**Type:** .csv
**Size:** 45122 characters

---

## File Metadata
- **Full Path:** `notebooks/data/Seattle2014.csv`
- **File Name:** `Seattle2014.csv`
- **Extension:** `.csv`
- **Size:** 45122 bytes
- **Last Modified:** 2025-11-18T22:10:25.670523
...
## High-Level Overview
This is a data file (`Seattle2014.csv`).

**Data Statistics:**
- Total lines: 367
- Columns: 17
- Column names: STATION, STATION_NAME, DATE, PRCP, SNWD, SNOW, TMAX, TMIN, AWND, WDF2
  ... and 7 more
...
Located at: `notebooks/data/Seattle2014.csv`

## Performance and Security Notes
- File size: 45122 bytes
